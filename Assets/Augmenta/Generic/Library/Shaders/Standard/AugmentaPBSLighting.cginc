#ifndef AUGMENTA_PBS_LIGHTING_INCLUDED
#define AUGMENTA_PBS_LIGHTING_INCLUDED
...
//-------------------------------------------------------------------------------------
// Default BRDF to use:
#if (SHADER_TARGET < 30) || defined(SHADER_API_PSP2) || defined(BRDF_Q_LOW)
	// Fallback to low fidelity one for pre-SM3.0
	#define UNITY_BRDF_PBS BRDF3_Unity_PBS
#elif defined(SHADER_API_MOBILE)  || defined(BRDF_Q_MED)
	// Somewhat simplified for mobile
	#define UNITY_BRDF_PBS BRDF2_Unity_PBS
#elif defined(BRDF_Q_HIGH)
