...
{
	public class Resources_EditorWindow : EditorWindow
	{
		...
		[MenuItem("Augmenta/Windows/Resources Browser")]
		public static void ShowWindow()
		{
			GetWindow<Resources_EditorWindow>(false, "Resources Browser", true);
		}
